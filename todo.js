...
function popfunc1() {
    ...
    <input type="text" placeholder="Add New List" id="name" autofocus>
    <div class="N1">
...
let addList = () => {
    ...
    container.innerHTML += `<div id= ${itemCount} class="item">
            ...
            <i class="fa-solid fa-circle-plus addtask" id="add-btn-${itemCount++}" onclick="popfunc2(); getListID(event)"></i>
        </div>`;
    let body = document.getElementsByTagName("body")[0];
...
function popfunc2() {
    ...
    <input type="text" placeholder="Add New Item" id="name" autofocus>
    <div class="N1">
...
let addItem = () => {
    let item_title = document.getElementById("name").value;
...
let delList = (trash_can) => {
    ...
    if (taskList.length === 0) {
        ...
        document.getElementById("default").style.opacity = 0.7;
    };
};
...
let expandItem = (card) => {
    ...
    `<header class="item_expand_header">
      ...
      <div class="expAdd" onclick="popfunc1()">
